        ...
        <div className="w-full mt-12">
            <div className="flex">
                <div className="mr-10 md:mr-3">
                    ...
                    <h1 className="text-[1.5rem] font-[600] text-second-dark-text-color xl:whitespace-nowrap lg:max-w-[100px]">{data.fullname}</h1>
                </div>
                <div className="flex-[1]">
                    ...
                    <div className="flex items-center mt-5">
                        <button
                            ...
                            className="btn button-dark-theme btn-square text-[1.5rem] text-main-dark-bg-color">
                            <BsFillReplyFill />
                        </button>
                    </div>
                </div>
            </div>
            {
                data.childs.length > 0 && (
                    <div className="pl-[120px] lg:pl-[60px] relative">
                                ...
                                <Fragment key={item.id}>
                                    <div className="flex mt-6">
                                        <div className="mr-10 md:mr-3">
                                            ...
                                            <h1 className="text-[1.5rem] font-[600] text-second-dark-text-color xl:whitespace-nowrap lg:max-w-[100px]">{item.fullname}</h1>
                                        </div>
                                        <div className="flex-[1]">
                        ...
                        <div className="absolute left-[30px] lg:left-[15px] top-1/2 -translate-y-1/2 text-[5rem]">
